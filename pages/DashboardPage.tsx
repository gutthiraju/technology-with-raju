        ...
        <div className="flex gap-4">
          ...
          <div className="bg-white dark:bg-slate-900 px-6 py-3 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-bold">64% Overall</div>
            </div>
          </div>
        </div>
      </div>
          ...
          {purchasedCourses.length > 0 ? (
            <div className="grid sm:grid-cols-2 gap-6">
              {purchasedCourses.map(course => (
                <div key={course.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 hover:border-indigo-500 transition-colors">
                  <div className="aspect-video rounded-xl overflow-hidden mb-4">
                    <img src={course.thumbnail} alt={course.title} className="w-full h-full object-cover" />
                  </div>
                  <h3 className="font-bold mb-1 truncate">{course.title}</h3>
                  <div className="text-xs text-slate-400 mb-4">{course.lessons} lessons left</div>
